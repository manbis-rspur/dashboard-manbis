...
/**
 * Mengambil satu lampiran tugas.
 *
 * Berkasnya tersimpan di wadah tertutup, jadi tidak ada alamat
 * langsung yang bisa terbagikan tanpa sengaja. Izinnya tidak
 * diperiksa di sini melainkan oleh aturan tabelnya: kueri di bawah
 * memakai sesi orang yang meminta, dan baris yang bukan haknya tidak
 * akan terbaca sama sekali.
 */
export async function GET(
  _permintaan: Request,
  { params }: RouteContext<"/tugas/lampiran/[id]">,
) {
