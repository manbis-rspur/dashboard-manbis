...
export default async function HalamanRiwayat({
  ...
  return (
    <div className="flex flex-col gap-7">
      <div>
        <Link href="/humas" className="text-sm text-tinta-3 hover:underline">
      ...
      {terbuka && (
        <div className="flex flex-col gap-3 rounded border border-garis bg-permukaan-2 p-5">
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <Link href="/humas/riwayat" className="text-sm text-tinta-3 hover:underline">
              Tutup
            </Link>
          </div>
            ...
            return (
              ...
              >
                <div className="mr-auto min-w-0">
                  <Link
                    href={`/humas/riwayat?dokumen=${r.id}`}
